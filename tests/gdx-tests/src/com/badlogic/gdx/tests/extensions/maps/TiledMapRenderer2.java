...
import com.badlogic.gdx.maps.MapRenderer2;
...
public class TiledMapRenderer2 implements MapRenderer2, Disposable {
	...
	public TiledMapRenderer2(TiledMap map) {
		this(map, new SpriteBatch());
		ownsSpriteBatch = true;
	}
	
	public TiledMapRenderer2(TiledMap map, float unitScale) {
		this(map, new SpriteBatch(), unitScale);
		ownsSpriteBatch = true;
	}
	
	public TiledMapRenderer2(TiledMap map, SpriteBatch spriteBatch) {
		this.map = map;
		this.spriteBatch = spriteBatch;
		this.ownsSpriteBatch = false;
	}
	
	public TiledMapRenderer2(TiledMap map, SpriteBatch spriteBatch, float unitScale) {
		this.map = map;
		this.spriteBatch = spriteBatch;
